  ...
  return (
    <div className="flex items-center justify-center min-h-full p-8">
      <Card variant="bordered" padding="lg" className="max-w-md text-center">
        ...
        <h2 className="text-xl font-bold text-[var(--gb-text-primary)] mb-2">
          {title}
        </h2>
        <p className="text-sm text-[var(--gb-text-secondary)] mb-4">
          {description}
        </p>
        <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-[var(--gb-bg-tertiary)] text-[var(--gb-text-tertiary)] border border-[var(--gb-border)]">
          Coming in {milestone}
        </span>
      </Card>
    </div>
